...
const DIALOGS: ILevelDialog[] = [
	{
		question: 'Apunar naam tu likhibo?',
		answers: ['moni','monimala','puwali', 'орли', 'אורלי'],
		hint: '(?) Are burbok tur kaar birthday...'
	},
	{
		question:
			'Next next....etia ko moi kun?<br>' +
			'<span class="dialog-hint">(...ha ha are june eitu bonaise)</span>',
		answers: [
			'jitul',
			'jubul',
			'jitulrajbongshi',
		...
		hint: '(?) Are, tolot saa likha e ase naam'
	},
	{
		question: 'Keita gift lagibo ko ?',
		answers: [],
		type: 'number'
	}
];
